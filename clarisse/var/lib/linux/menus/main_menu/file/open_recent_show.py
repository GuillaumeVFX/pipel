...
recent_location = ix.application.get_recent_files("project")
for i in range(recent_location.get_count()):
    ...
    command = "variables = {'project_path': '" + cur_recent_location + "'}\n"
...
menu.add_command("File>Open Recent>separator")
menu.add_command("File>Open Recent>Clear Recent", "./open_recent_clear_recent.py")